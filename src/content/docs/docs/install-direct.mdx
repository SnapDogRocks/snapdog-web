...
**SnapDog** is distributed as a lightweight, single statically-linked binary. It can be deployed on Linux (x86_64, aarch64, armv7), macOS, and Windows (x86_64, aarch64).
