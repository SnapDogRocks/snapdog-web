...
## SnapDog OS Installer (GPL-3.0-only)

[SnapDog OS Installer](https://github.com/SnapDogRocks/snapdog-os-installer), the native cross-platform SnapDog OS image writer, is distributed under the **GNU General Public License v3.0 only**.
