...
<Aside type="note">
  For running the server as a background service supervised by systemd or launchd, see the [Direct Installation Guide](/docs/install-direct#post-installation-service-scripts).
</Aside>
...
<CardGrid>
  <LinkCard
    ...
    description="Deploy background services natively or build the daemon from source."
    href="/docs/install-direct"
  />
  <LinkCard
    title="Docker Container"
    description="Run SnapDog inside a containerized setup."
