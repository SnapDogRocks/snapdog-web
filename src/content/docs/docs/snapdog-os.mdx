...
| **Raspberry Pi 4 / 400 / Zero 2 W** | 64-bit (`aarch64`) | [Download Image (.img.gz)](https://updates.snapdog.cc/os/images/snapdog-os-pi4-beta.img.gz) |
| **Raspberry Pi 3 / 3+** | 64-bit (`aarch64`) | [Download Image (.img.gz)](https://updates.snapdog.cc/os/images/snapdog-os-pi3-beta.img.gz) |

*Note: The Raspberry Pi 4 image is fully compatible with the Raspberry Pi Zero 2 W.*
