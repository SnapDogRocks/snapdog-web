...
|---|---|---|
| **Raspberry Pi 5 / 500** | 64-bit (`aarch64`) | [Download Image (.img.gz)](https://updates.snapdog.cc/os/images/snapdog-os-pi5-beta.img.gz) |
| **Raspberry Pi 4 / 400** | 64-bit (`aarch64`) | [Download Image (.img.gz)](https://updates.snapdog.cc/os/images/snapdog-os-pi4-beta.img.gz) |
| **Raspberry Pi 3 / 3+** | 64-bit (`aarch64`) | [Download Image (.img.gz)](https://updates.snapdog.cc/os/images/snapdog-os-pi3-beta.img.gz) |
| **Raspberry Pi Zero 2 W** | 64-bit (`aarch64`) | [Download Image (.img.gz)](https://updates.snapdog.cc/os/images/snapdog-os-zero2w-beta.img.gz) |
